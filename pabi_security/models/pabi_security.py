...
class PABISecurity(models.Model):
    ...
    mg11_label = fields.Char(string='MG11', compute='_compute_label')
    mg12_label = fields.Char(string='MG12', compute='_compute_label')
    mg13_label = fields.Char(string='MG13', compute='_compute_label')
    mg14_label = fields.Char(string='MG14', compute='_compute_label')
    mg15_label = fields.Char(string='MG15', compute='_compute_label')
    mg16_label = fields.Char(string='MG16', compute='_compute_label')
    mg17_label = fields.Char(string='MG17', compute='_compute_label')
    mg18_label = fields.Char(string='MG18', compute='_compute_label')
    mg19_label = fields.Char(string='MG19', compute='_compute_label')
    mg20_label = fields.Char(string='MG20', compute='_compute_label')
    mg21_label = fields.Char(string='MG21', compute='_compute_label')
    mg22_label = fields.Char(string='MG22', compute='_compute_label')
    mg23_label = fields.Char(string='MG23', compute='_compute_label')
    mg24_label = fields.Char(string='MG24', compute='_compute_label')
    mg25_label = fields.Char(string='MG25', compute='_compute_label')
    mg26_label = fields.Char(string='MG26', compute='_compute_label')
    mg27_label = fields.Char(string='MG27', compute='_compute_label')
    mg28_label = fields.Char(string='MG28', compute='_compute_label')
    mg29_label = fields.Char(string='MG29', compute='_compute_label')
    mg30_label = fields.Char(string='MG30', compute='_compute_label')
    # Groups
...
class PABISecurityLine(models.Model):
    ...
    mg11 = fields.Boolean(string='MG11', default=False)
    mg12 = fields.Boolean(string='MG12', default=False)
    mg13 = fields.Boolean(string='MG13', default=False)
    mg14 = fields.Boolean(string='MG14', default=False)
    mg15 = fields.Boolean(string='MG15', default=False)
    mg16 = fields.Boolean(string='MG16', default=False)
    mg17 = fields.Boolean(string='MG17', default=False)
    mg18 = fields.Boolean(string='MG18', default=False)
    mg19 = fields.Boolean(string='MG19', default=False)
    mg20 = fields.Boolean(string='MG20', default=False)
    mg21 = fields.Boolean(string='MG21', default=False)
    mg22 = fields.Boolean(string='MG22', default=False)
    mg23 = fields.Boolean(string='MG23', default=False)
    mg24 = fields.Boolean(string='MG24', default=False)
    mg25 = fields.Boolean(string='MG25', default=False)
    mg26 = fields.Boolean(string='MG26', default=False)
    mg27 = fields.Boolean(string='MG27', default=False)
    mg28 = fields.Boolean(string='MG28', default=False)
    mg29 = fields.Boolean(string='MG29', default=False)
    mg30 = fields.Boolean(string='MG30', default=False)
    # Groups
