    ...
    def generate_xls_report(self, _p, _xs, data, objects, wb):
        ...
        c_specs = [
            ...
            ('operating_unit', 1, 0, 'text',
             _('OU Code'), None, c_hdr_cell_style),  # kittiu
            ('analytic', 1, 0, 'text',
             _('Project Code'), None, c_hdr_cell_style),  # kittiu
            ...
            if _p.display_account_raw(data) == 'all' or \
                ...
                for line in _p['ledger_lines'][account.id]:
                    ...
                    c_specs += [
                        ...
                        ('operating_unit', 1, 0, 'text',
                         line.get('operating_unit') or ''),  # kittiu
                        ('analytic', 1, 0, 'text',
                         line.get('analytic') or ''),  # kittiu
                        ('partner', 1, 0, 'text',
...
# Change this to CMO's
general_ledger_xls('report.account.cmo_report_general_ledger_xls',
                   'account.account',
